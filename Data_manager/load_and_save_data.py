...
#
#
# file_list = glob.glob(os.getcwd() + "/Data_manager_split_datasets/*/*/*/splitted_data*")
#
#
#
...
#     file_path = new_file_path[0:-len(file_name)]
#
#     if "_file_list" in file_name or ".npz" in file_name:
#          # print("Skip")
#         pass
#     else:
#
#         print("Parsing: " + new_file_path)
#
#         try:
#
#             pickle_original_file = pickle.load(open(new_file_path, "rb"))
#             pickle_original_data_dict= {}
#
#
#
#
#             for attrib_name in pickle_original_file.keys():
#                  pickle_original_data_dict[attrib_name] = pickle_original_file[attrib_name]
#
#
#             save_data_dict(pickle_original_data_dict, file_path, file_name)
#
#
#         except Exception as e:
#
#             print("On file {} Exception {}".format(new_file_path, str(e)))
#             traceback.print_exc()
#
