...
class PinterestICCVReader(object):
    ...
    def __init__(self):
        ...
        pre_splitted_path = "Data_manager_split_datasets/PinterestICCV/WWW/NeuCF_our_interface/"
        ...
        try:
            ...
            dataset = Dataset_github("Conferences/WWW/NeuCF_github/Data/pinterest-20")
