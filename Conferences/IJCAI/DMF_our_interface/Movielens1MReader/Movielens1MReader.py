...
class Movielens1MReader:
    ...
    def __init__(self, pre_splitted_path):
        ...
        try:
            ...
            URM_all = filter_urm(URM_all, user_min_number_ratings=0, item_min_number_ratings=5)
            URM_all = filter_urm(URM_all, user_min_number_ratings=20, item_min_number_ratings=0)
            URM_timestamp = filter_urm(URM_timestamp, user_min_number_ratings=0, item_min_number_ratings=5)
