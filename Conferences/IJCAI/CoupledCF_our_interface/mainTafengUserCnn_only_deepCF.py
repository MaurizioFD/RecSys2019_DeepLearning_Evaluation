...
from keras.layers import Embedding, Input, merge, Conv2D, Multiply, Concatenate
...
# from evaluateTafengCnn_only_deepCF import evaluate_model


def get_train_instances(ratings, num_negatives=4):
...
def get_train_instances_old(users_attr_mat, ratings, items_genres_mat):
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        user_id_input, item_id_input, labels = get_train_instances(ratings, num_negatives=num_negatives)
