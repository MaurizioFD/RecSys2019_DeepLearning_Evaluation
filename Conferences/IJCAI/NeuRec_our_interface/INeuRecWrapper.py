...
from Conferences.IJCAI.NeuRec_our_interface.INeuRec import INeuRec


class INeuRec_RecommenderWrapper(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):


    RECOMMENDER_NAME = "INeuRec_RecommenderWrapper"
