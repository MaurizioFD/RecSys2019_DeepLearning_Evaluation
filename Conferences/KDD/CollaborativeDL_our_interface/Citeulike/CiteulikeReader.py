...
class CiteulikeReader(object):
    ...
    def __init__(self, dataset_variant = "a", train_interactions = 1):
        ...
        pre_splitted_path = "Data_manager_split_datasets/CiteULike/KDD/CollaborativeDL_our_interface/"


        pre_splitted_filename = "splitted_data_citeulike-{}-{}-items".format(dataset_variant, train_interactions)


        original_data_path = "Conferences/KDD/CollaborativeDL_github_python/data/citeulike-{}/".format(dataset_variant)
